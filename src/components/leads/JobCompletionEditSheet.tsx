...
> = {
  ...
  5: {
    ...
    methodHepaAirScrubberInstallation: 'HEPA Air Scrubber Installation',
  ...
  6: {
    chemicalAirFiltration: 'Air Filtration Treatment',
  ...
  7: {
    ...
    actualHepaAirScrubberQty: 'HEPA Air Scrubber Qty',
