...
import { ArrowLeft, Bell, CheckCircle, AlertTriangle, Trash2, Check } from 'lucide-react';
...
export default function AllNotifications() {
  ...
  const renderIcon = (type: string) => {
    if (type === 'success') return <CheckCircle size={24} strokeWidth={2} />;
    if (type === 'warning') return <AlertTriangle size={24} strokeWidth={2} />;
